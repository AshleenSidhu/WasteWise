  ...
  return (
    <footer className="bg-gradient-to-b from-white to-green-50 border-t border-green-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4 max-w-md">
              Making waste sorting smarter and greener for communities everywhere. 
              Find bins, report issues, and help keep your neighborhood clean! 🌱
            </p>
            {/* Mascot */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://github.com/AshleenSidhu/WasteWise"
                  target="_blank"
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-green-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm text-center md:text-left">
            © 2025 WasteWise. Built with 💚 by Team WasteWise.
          </p>
